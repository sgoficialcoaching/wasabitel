            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div className="bg-white p-4 rounded-lg">
                  <h4 className="font-bold text-orange-900 mb-2">Google Analytics</h4>
                  <p className="text-orange-800 text-sm">
                    Para análisis estadístico del tráfico web. Los datos se procesan de forma anónima.
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <h4 className="font-bold text-orange-900 mb-2">WhatsApp Business</h4>
                  <p className="text-orange-800 text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                ...
                <p className="text-yellow-800">
                  ...
                  no funcionen correctamente, como los formularios de contacto o la personalización de contenidos.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-green-50 p-6 rounded-xl">
              <p className="text-green-800 mb-4">
                Al continuar navegando por nuestro sitio web, aceptas el uso de cookies según se describe en esta política. 
                Puedes retirar tu consentimiento en cualquier momento modificando la configuración de tu navegador.
              </p>
              <p className="text-green-800">
                Para las cookies no técnicas, solicitaremos tu consentimiento específico mediante un banner informativo 
                la primera vez que visites nuestro sitio web.
              </p>
            </div>
          </section>
