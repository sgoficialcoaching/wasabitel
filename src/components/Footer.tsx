...
const Footer: React.FC<FooterProps> = ({ onCallRequestClick }) => {
  ...
  return (
    <footer id="contacto" className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <div className="flex space-x-4">
                {[Facebook, Twitter, Instagram, Linkedin, Youtube].map((Icon, index) => (
                  <a key={index} href="#" className="w-12 h-12 bg-gray-800 hover:bg-gradient-to-br hover:from-teal-500 hover:to-orange-500 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 border border-gray-700">
              <h3 className="text-2xl font-bold mb-6 text-center">Contacto Directo</h3>
              <div className="space-y-6">
                <div className="flex items-center space-x-4 p-4 bg-gray-700/50 rounded-2xl">
                  <div className="w-12 h-12 bg-gradient-to-br from-teal-500 to-teal-600 rounded-xl flex items-center justify-center">
                    <Phone className="w-6 h-6" />
                  </div>
                  <div>
                    <div className="font-bold text-lg">621 50 83 00</div>
                ...
                <div className="flex items-center space-x-4 p-4 bg-gray-700/50 rounded-2xl">
                  ...
                  <div>
                    <div className="font-bold text-lg">info@wasabitel.com</div>
                ...
                <div className="flex items-center space-x-4 p-4 bg-gray-700/50 rounded-2xl">
                  ...
                  <div>
                    <div className="font-bold text-lg">Madrid, España</div>
                    <div className="text-gray-400 text-sm">Oficinas centrales</div>
                  </div>
                </div>
              </div>
              
              <button onClick={onCallRequestClick} className="w-full mt-6 bg-gradient-to-r from-teal-500 to-orange-500 hover:from-teal-600 hover:to-orange-600 text-white py-4 rounded-2xl font-bold transition-all duration-300 transform hover:scale-105">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              ...
              <ul className="space-y-3">
                {services.map((item, index) => (
                  <li key={index}>
                    <button onClick={(e) => handleLinkClick(item.href, e)} className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center group text-left">
            ...
            <div>
              <h4 className="text-xl font-bold mb-6 text-orange-400">Empresa</h4>
              <ul className="space-y-3">
            ...
            <div>
              <h4 className="text-xl font-bold mb-6 text-blue-400">Soporte</h4>
              <ul className="space-y-3">
        ...
        <div className="border-t border-gray-700 py-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <button onClick={(e) => handleLinkClick('/politica-privacidad', e)} className="text-gray-400 hover:text-white text-sm transition-colors duration-300">
                Política de Privacidad
              </button>
              <button onClick={(e) => handleLinkClick('/terminos-condiciones', e)} className="text-gray-400 hover:text-white text-sm transition-colors duration-300">
                Términos y Condiciones
              </button>
              <button onClick={(e) => handleLinkClick('/cookies', e)} className="text-gray-400 hover:text-white text-sm transition-colors duration-300">
                Cookies
              </button>
              <button onClick={(e) => handleLinkClick('/aviso-legal', e)} className="text-gray-400 hover:text-white text-sm transition-colors duration-300">
                Aviso Legal
              </button>
            </div>
          </div>
